<template>
  ...
  >
    <router-link to="/found" class="no-underline flex flex-col items-center group">
      ...
      <span class="hidden md:block text-xs lg:text-sm font-medium mt-1 group-hover:text-laranja" :class="{ 'text-laranja': activeIcon == 'search' }">Achados</span>
    </router-link>
    ...
    <router-link to="/chats" class="no-underline flex flex-col items-center group">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        fill="none"
        viewBox="0 0 24 24"
      ...
      <span class="hidden md:block text-xs lg:text-sm font-medium mt-1 group-hover:text-laranja" :class="{ 'text-laranja': activeIcon == 'chat' }">Conversas</span>
    </router-link>
  </div>
</template>
